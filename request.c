...
// Some of this code taken from Computer Systems: A Programmer's Perspective by Randal E. Bryant and David R. O'Hallaron
...
void request_error(int fd, char *cause, char *errnum, char *shortmsg, char *longmsg)
{
    ...
    sprintf(body, ""
                  "<!doctype html>\r\n"
                  "<head>\r\n"
                  "  <title>KK WebServer Error</title>\r\n"
                  "</head>\r\n"
                  "<body>\r\n"
                  "  <h2>%s: %s</h2>\r\n"
                  "  <p>%s: %s</p>\r\n"
...
int request_parse_uri(char *uri, char *filename, char *cgiargs)
{
    ...
    log_info("Inside request parse uri");
    char *ptr;
